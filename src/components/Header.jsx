  ...
  return (
    <header className="fixed top-0 left-0 m-auto max_padd_container w-full bg-white ring-1 ring-slate-900/5 z-10">
      <div className="px-4 flexBetween py-3 max-xs:px-2">
        ...
        <div>
          <Link to="/">
            <img src={logo} width={66} height={88} alt="Logo_image" />
          </Link>
        </div>
        ...
        <div className="flexBetween sm:gap-x-2 bold-16">
          ...
          <div className="flexBetween sm:gap-x-6">
            ...
            {/* <NavLink to={'logout'} className={"btn_secondary_rounded flexCenter gap-x-2 medium-16"}><img src={logout} alt="logoutIcons" height={19} width={19}/> Logout</NavLink> */}
            <NavLink
              to={"login"}
              className={"btn_secondary_rounded flexCenter gap-x-2 medium-16"}
            >
              <img src={user} alt="usericons" height={19} width={19} />
              Login
            </NavLink>
          </div>
        </div>
