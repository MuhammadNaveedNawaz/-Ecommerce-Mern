...
const Item = ({ id, name, image, old_price, new_price }) => {
  ...
  className='h-12 w-12 bg-white rounded-full flexCenter absolute top-1/2 -translate-y-1/2 !py-2 z-20 scale-0 group-hover:scale-100 transition-all duration-700'
>
